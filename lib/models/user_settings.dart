...
class UserPreferenceSettings {
  ...
  factory UserPreferenceSettings.fromJson(Map<String, dynamic> json,
    ...
    return UserPreferenceSettings(
      ...
      matrixTodayOnly:
          _parseBool(json['matrixTodayOnly']) ?? defaults.matrixTodayOnly,
    );
  }
  ...
  Map<String, dynamic> toJson() => {
        ...
        'matrixTodayOnly': matrixTodayOnly,
      };
  ...
  UserPreferenceSettings copyWith({
    ...
    return UserPreferenceSettings(
      ...
      matrixTodayOnly: matrixTodayOnly ?? this.matrixTodayOnly,
    );
  }
}
